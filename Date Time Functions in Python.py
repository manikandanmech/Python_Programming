...
"""
Python datetime module is provided in Python to work with dates and times. 
A date in Python is not a data type of its own, but we can import a module named datetime to work with dates as date objects.
These classes provide a number of functions to deal with dates, times and time intervals.

>>common date and time-related functions in Python:
...
dob_year = dt.datetime(2024, 2, 11)
difference = dob_year - current
print(difference)
print("--------------------------------------")
current = dt.datetime.now()
print(current)
